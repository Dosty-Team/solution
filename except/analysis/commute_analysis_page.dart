...
Widget build(BuildContext context) {
  ...
  return Scaffold(
    // Use an AppBar to fix the back icon and title at the top
    appBar: AppBar(
    ...
    body: Container(
      ...
      child: SafeArea(
        child: SingleChildScrollView(
          // Ensures content is scrollable and starts from the top.
          child: Center(
            ...
            child: Container(
              ...
              child: Column(
                // Column with top alignment (default)
...
class _RouteChartData {
  ...
  final List<String> times; // Should be length 6
  final List<double> heights; // Should be length 6
  final List<String> categories; // Should be length 6
